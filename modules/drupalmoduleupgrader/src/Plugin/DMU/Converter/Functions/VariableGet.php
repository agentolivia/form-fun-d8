...
config/install/@module.settings.yml and config/schema/@module.settings.yml.
END;
  ...
  public function convert(TargetInterface $target) {
    ...
    if ($this->defaults && $this->schema) {
      ...
      $this->write($target, InstallStorage::CONFIG_SCHEMA_DIRECTORY . '/' . $group . '.yml', Yaml::encode($schema));
      $this->schema = [];
    }
  }
